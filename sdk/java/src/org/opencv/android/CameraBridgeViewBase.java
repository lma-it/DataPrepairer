...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public interface CvCameraViewListener2 {
         ...
         * @param height - the height of the frames that will be delivered
         */
        public void onCameraViewStarted(int width, int height) throws InterruptedException;
     ...
     */
    public void enableView() throws InterruptedException {
        synchronized(mSyncObject) {
            mEnabled = true;
            checkCurrentState();
        }
     ...
     */
    public void disableView() throws InterruptedException {
        synchronized(mSyncObject) {
            mEnabled = false;
            checkCurrentState();
        }
     ...
     */
    private void checkCurrentState() throws InterruptedException {
    ...
    private void processEnterState(int state) throws InterruptedException {
     ...
     */
//    protected void deliverAndDrawFrame(CvCameraViewFrame frame) throws InterruptedException {
//        Mat modified;
//
//        if (mListener != null) {
...
//    }
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) throws IOException, InterruptedException {
        Mat modified;
